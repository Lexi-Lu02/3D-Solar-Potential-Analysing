"""
Batch Solar API Fetcher
-----------------------
Reads structure_ids from the buildings table and calls the local FastAPI
endpoint for each one. The endpoint handles caching automatically —
already-fetched buildings are skipped on the API side (cache hit).

Usage:
    python batch_solar_fetch.py
